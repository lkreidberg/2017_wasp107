...
We combined our high precision transmission spectrum of WASP-107b with interior structure modeling to assess the planet's atmospheric composition. 

Upper limit on metallicity. The planet's radius is so large that we put an upper limit on the metallicity (additional metals would compress it).  metallicity 30x solar - how does this compare to mass/atmospheric metallicity 

Methane depletion
low C/O ratio - planetesimal enrichment (cite Nestor)
internal heat, directly imaged planets

Thick, high-altitude condensate layer
