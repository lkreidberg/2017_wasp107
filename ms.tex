...
The best fit light curves have a median reduced $\chi_2$ value of 1.16.  To ensure that we do not underestimate the uncertainty on the transit depths, we rescale the photometric uncertainties for all spectroscopic channels such that the $\chi_2$ values are unity. We performed an MCMC fit to the light curves with \texttt{emcee}. The median transit depths and $1\,\sigma$ uncertainties are given in Table FIXME. 
...
\tablecaption{WASP-107b transmission spectrum \label{transit_depths}}
