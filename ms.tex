...
\caption{Retrieved distributions for (a) metallicity, (b) carbon-to-oxygen ratio, (c) irradiation temperature, and (d) cloud-top pressure. Dashed vertical lines show the median and $\pm1\,\sigma$ confidence interval. Solar metallicity and C/O values are indicated with solid vertical lines.}  
\label{fig:retrieval}
\end{figure}
